...
./COMMON/rdhead.f90 ./ATOM/apot.f90 ./ATOM/reset_atom_common.f90 \
...
./ATOM/nucmass.f90 ./ATOM/soldir.f90 ./ATOM/intdir.f90 \
...
./ATOM/cofcon.f90 ./ATOM/etotal.f90 ./ATOM/fdmocc.f90 \
./ATOM/bkmrdf.f90 ./ATOM/tabrat.f90 ./MATH/somm.f90 \
./ATOM/potslw.f90 ./ATOM/fpf0.f90 ./ATOM/s02at.f90 \
./MATH/determ.f90 ./COMMON/xx.f90 ./MATH/terp.f90 \
./MATH/polint.f90 ./POT/ovrlp.f90 ./MATH/dist.f90 \
./POT/sumax.f90 ./POT/frnrm.f90 ./MATH/somm2.f90 \
./COMMON/setgam.f90 ./COMMON/padlib.f90 
atomic_MODULESRC = \
